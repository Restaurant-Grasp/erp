...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        ...
        @endphp
        @if ($permissions->contains('name', 'category.create'))
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Name</th>
                        <th>Code</th>
                        @if ($permissions->contains('name', 'category.edit') || $permissions->contains('name', 'category.delete'))
                        <th>Actions</th>
                        @endif
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        @if ($permissions->contains('name', 'category.edit') || $permissions->contains('name', 'category.delete'))
                        <td>
                            @if ($permissions->contains('name', 'category.edit'))
                            <a href="{{ route('categories.edit', $categories) }}" class="btn btn-sm btn-outline-primary"
                                title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            @endif
                            @if ($permissions->contains('name', 'category.delete'))
