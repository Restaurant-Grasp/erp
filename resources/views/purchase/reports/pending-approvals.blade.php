        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center py-4">
                    ...
                    <p class="text-muted">No monthly trend data available for the selected period</p>
                </div>
                @endif
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                            $percentage = ($poSummary['total_amount'] ?? 0) > 0 ? ($vendor->total_amount / $poSummary['total_amount']) * 100 : 0;
                            @endphp
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                            $categoryPercentage = ($poSummary['total_amount'] ?? 0) > 0 ? ($category->total_amount / $poSummary['total_amount']) * 100 : 0;
                            @endphp
                            <div class="progress" style="height: 20px;">
