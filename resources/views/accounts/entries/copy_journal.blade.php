@extends('layouts.app')
@section('title', 'Copy Journal Entry')
@section('content')
    ...
    <div class="col-12">
        ...
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Copy Journal Entry</li>
            </ol>
        </nav>
        ...
        <form method="POST" action="{{ route('accounts.journal.store') }}" id="journalForm" onsubmit="return validateAndSubmit()">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0">Copy Journal Entry</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <strong><i class="fas fa-balance-scale me-1"></i>Status:</strong><br>
                                @if($sourceEntry->isBalanced())
                            ...
                            <div class="col-md-3">
                                <strong><i class="fas fa-list me-1"></i>Items:</strong><br>
                                {{ $sourceEntry->entryItems->count() }} journal items
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-3">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-plus me-2"></i>Add Additional Journal Items</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="card mb-3">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="mb-0"><i class="fas fa-list me-2"></i>Journal Items (Copied)</h6>
                        <small class="text-white-50">Original had {{ $sourceEntry->entryItems->count() }} item(s)</small>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <textarea name="narration" class="form-control" rows="4" 
                              placeholder="Enter detailed description of the journal entry">{{ old('narration', $sourceEntry->narration) }}</textarea>
...
$(document).ready(function() {
    ...
    // Pre-populate items from source entry
    @foreach($sourceEntry->entryItems as $item)
        addItemToTable(
            '{{ $item->ledger_id }}',
        ...
        if (!$('.alert-success').length) {
            $('body').prepend(`
                <div class="alert alert-success alert-dismissible fade show position-fixed" style="top: 20px; right: 20px; z-index: 9999; max-width: 400px;">
                    ...
                    <strong>Journal Entry Copied!</strong><br>
                    All data has been copied from <code>${{ $sourceEntry->entry_code }}</code>. 
                    Modify as needed and save to create a new journal entry.
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            `);
        }
