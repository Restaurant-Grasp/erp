...
<body>
    ...
    <table width="750" border="0" align="center" id="backButon">
        <tr>
            ...
            <td width="100" style="vertical-align:top;">
                <a href="{{ route('accounts.payment.list') }}">
    ...
    <table width="750" style="border-top:2px solid #c2c2c2;padding: 7px 0px;" align="center">
        <tr>
            <td width="200"></td>
            <td width="350" style="font-size:26px;text-align:center;font-weight: bold;text-transform: uppercase;">Payment Voucher</td>
            <td width="200"></td>
        </tr>
    </table>
    ...
    <table width="750" border="0" align="center" cellpadding="3">
        ...
        <tr style="font-size:14px;">
            ...
            <td colspan="3">{{ $creditAccount->ledger->name }}</td>
        </tr>
    ...
    <table width="750" border="0" align="center" style="border-collapse:collapse;">
        <tr style="font-size: 14px;">
            <td align="right" width="600"><span style="font-size:14px;font-weight:bold;">Total Amount Paid:</span></td>
			@php
