    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5> Create New Account Group</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('chart_of_accounts.group.store') }}" id="groupForm">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group mb-3">
                                ...
                                @enderror
                                <div class="form-text">
                                    Groups must be created under existing parent groups
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    // Initialize on page load if parent is already selected
    updateCodeRangeHint();
...
function showCodeGuidelines(baseCode, rangeStart, rangeEnd, parentName) {
    ...
    var guidelines = `
        ...
        <ul>
            <li>Next available: ${rangeStart}</li>
            <li>Suggested codes: ${rangeStart}, ${rangeStart + 10}, ${rangeStart + 20}</li>
        </ul>
        <p><small><strong>Note:</strong> Leave gaps between codes for future expansion.</small></p>
    `;
